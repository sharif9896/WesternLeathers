...
const Categories = () =>{
    ...
    const maindata = product.filter((data)=> productdata.category === data.category && productdata.subcategory === data.subcategory)
    return (
        <>
        <br />

        <div className="text-left mx-20 py-2 text-3xl">
        <Title text1={productdata.category} text2={productdata.subcategory}></Title>
        </div>
